...
namespace WebApplication1
{
    ...
    /// Date 13/07/207
    /// </summary>
    public partial class Add_Feeders : System.Web.UI.Page
    {
        ...
        protected void fn_edit_Feeders_Details(string binid)
        {
            string name = Request.Form["Name"];

            DataSet edit_bin = new DataSet();
            edit_bin = ob.fn_edit_Feeders_Details(binid);
            DdlZone.SelectedValue = edit_bin.Tables[0].Rows[0]["Zone_id"].ToString();
            bind_ward_bind(edit_bin.Tables[0].Rows[0]["Zone_id"].ToString());
            DdlWard.SelectedValue = edit_bin.Tables[0].Rows[0]["ward_id"].ToString();
            ...
            f_name.Text = edit_bin.Tables[0].Rows[0]["FeederName"].ToString();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            ds2 = ob.Fn_Insert_new_Feeders(DdlZone.SelectedItem.Text,DdlZone.SelectedValue, DdlWard.SelectedItem.Text,DdlWard.SelectedValue, name.Replace("'","_"), blat.Text, blon.Text, f_name.Text);
            ...
            {
                MessageBox.Show("Feeder Added Successfully");
            }
            else
                if (ds2.Tables[0].Rows[0]["msg"].ToString() == "N")
                {
                    MessageBox.Show(" Due to Some Problems feeder not Add");
                }
        ...
        protected void Btnupdate_Click(object sender, EventArgs e)
        {
            DataSet ds = new DataSet();
            string name = Request.Form["Name"];
            ds = ob.fn_update_Feeders(ViewState["bin_id"].ToString(), DdlZone.SelectedValue, DdlWard.SelectedValue, name, blat.Text, blon.Text, f_name.Text, DdlZone.SelectedItem.Text, DdlWard.SelectedItem.Text);
            ...
            Response.Redirect("View_Feeders.aspx");
        }
