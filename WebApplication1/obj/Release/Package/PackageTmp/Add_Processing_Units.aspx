<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Waste_Mgmnt.Master" AutoEventWireup="true" CodeBehind="Add_Processing_Units.aspx.cs" Inherits="WebApplication1.Add_Processing_Units" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script>
     ...
     <div class="row">
        <div style="margin-top:12px;"><fieldset><legend><h3>Enter Processing Unit Details</h3></legend></fieldset></div>
        <br />
           <div>
    ...
    <div>
        ...
        <asp:TextBox ID="blon" required="required"  class="form-control"   runat="server"  ></asp:TextBox>
         ...
         <br />
        <div>
          <div class="col-sm-2">Processing Unit Name</div>
