<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Waste_Mgmnt.Master" AutoEventWireup="true" CodeBehind="View_Feeders.aspx.cs" Inherits="WebApplication1.View_Feeders" %>
    ...
    <asp:GridView ID="GridView1" class="table table-bordered table-striped" runat="server" AutoGenerateColumns="False">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Feeder Name">
                <ItemTemplate>
                    <asp:Label ID="Label2" runat="server" Text='<%# Eval("FeederName") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
