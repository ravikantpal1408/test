...
{
    public partial class viewfeeders1 : System.Web.UI.Page
    {
        ...
        public void search_feeders_Zone_wise(string zone)
        {
            ds = ob.Fn_select_FeedersZoneWise(zone);
            GridView1.DataSource = ds;
            GridView1.DataBind();
        }
        ...
        protected void LinkEdit_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("Add_Feeders.aspx?binid=" + BinId);
        }
        ...
        protected void LinkDel_Click(object sender, EventArgs e)
        {
            ...
            DataSet ds = new DataSet();
            ds = ob.fn_Delete_Feeders_Details(BinIdd);
